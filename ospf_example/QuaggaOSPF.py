...
#    r2.cmd('zebra -f /usr/local/etc/r2zebra.conf -d -i ~/Desktop/r2zebra > ~/Desktop/r2zebra.log')
    ...
    r1.cmd('zebra -f /etc/quagga/r1zebra.conf -d -z /etc/quagga/temp/r1zebra.api -i /etc/quagga/temp/r1zebra.interface')
...
#    r1.cmd('ripd -f /usr/local/etc/r1ripd.conf -d -i ~/Desktop/r1ripd > ~/Desktop/r1ripd.log')
    ...
    r2.cmd('zebra -f /etc/quagga/r2zebra.conf -d -z /etc/quagga/temp/r2zebra.api -i /etc/quagga/temp/r2zebra.interface')
    r1.cmd('ospfd -f /etc/quagga/r1ospfd.conf -d -z /etc/quagga/temp/r1zebra.api -i /etc/quagga/temp/r1ospfd.interface')

#    r2.cmd('ripd -f /usr/local/etc/r2ripd.conf -d -i ~/Desktop/r2ripd > ~/Desktop/r2ripd.log')
    r2.cmd('ospfd -f /etc/quagga/r2ospfd.conf -d -z /etc/quagga/temp/r2zebra.api -i /etc/quagga/temp/r2ospfd.interface')
